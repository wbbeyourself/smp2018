...
model = get_cgru(Config2.char_seq_maxlen, char_embed_weight)
...
for i in range(15):
    ...
    if f1_mean > best_f1:
        best_f1 = f1_mean
        model.save(Config2.cache_dir + '/char_cgru/%s_epoch_%s_%s_%.7s.h5' % (model_name, i, f1, best_f1))
