...
class Config2():
    data_dir = '/home/wb/text-classification/data'
    raw_data_dir = data_dir
    cache_dir = data_dir

    # 原始数据
    train_raw_org_path = raw_data_dir + '/training_new.txt'
    # train_raw_org_path = raw_data_dir + '/training_100.txt'
    val_raw_org_path = raw_data_dir + '/validation_new.txt'

    # 训练集的样本
    train_org_path = data_dir + '/train_data/training_hanlp_cut.txt'
    train_all_data_path = data_dir + '/all.csv'
    # train_all_cut_path = data_dir + '/train_data/all__cut.csv'
    ...
    # vali_cut_path = data_dir + '/validation_data/validation_cut.csv'
    ...
    # 模型路径
    textcnn_model_path = cache_dir + '/cnn/dp_embed_word_cnn_epoch_2_[0.96183446 0.99511651 0.99903661 0.97265461].h5'
